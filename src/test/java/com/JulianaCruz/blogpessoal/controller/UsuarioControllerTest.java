...
import com.JulianaCruz.blogpessoal.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, "Paulo Antunes",
				"https://i.imgur.com/FETvs20.jpg", "paulo_antunes@email.com.br", "13465278"));
	...
	@Test
	@Order(2)
	@DisplayName(" Não deve permirtir duplicação do usuario")
	public void naoDeveDuplicarUsuario() {

		usuarioService.cadastrarUsuario(new Usuario(0L, "Maria da Silva", "https://i.imurg.com/NtyGneo.jpg",
				"maria_silva@email.com.br", "13465278"));

		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, "maria da Silva",
				"https://imgur.com/NtyGneo.jpg", "maria_silva@email.com.br", "13465278"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L, "Juliana Andrews Ramos",
				"https://i.imgur.com/yDRVeK7.jpg", "juliana_ramos@email.com.br", "juliana123"));
